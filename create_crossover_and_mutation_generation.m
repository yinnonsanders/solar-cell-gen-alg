...
function [generationList, listOfMeans] = create_crossover_and_mutation_generation(A, tuner, matrixList, generationCount)
    ...
    for gen = 1:generationCount
        ...
        for mat = 1:matrixCount
            ...
            mutationMatrixList{1, mat} = matrixMutate(matrixList{1, mat}, 1/tuner * matrixElementCount, tuner);
        end
        ...
        matrixList = [crossoverMatrixList(1, 1:splittingNumber), mutationMatrixList(1,splittingNumber + 1:end)];
    end
    generationList{1, gen} = matrixList;
end