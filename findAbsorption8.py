...
"""findAbsorptions8.py: finds absorption of structure and saves to absorptions.txt"""
...
path = sys.argv[1]
freqs = open("/home/ubuntu/solar-cell-gen-alg/freqs8.txt", "r")
emptytfluxes = open("/home/ubuntu/solar-cell-gen-alg/emptytfluxes8.txt", "r")
emptyrfluxes = open("/home/ubuntu/solar-cell-gen-alg/emptyrfluxes8.txt", "r")
